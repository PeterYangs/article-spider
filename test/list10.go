...
func main() {
	...
	f := form.Form{
		...
		DetailFields: map[string]form.Field{
			//"img": {Types: fileTypes.SingleImage, Selector: "body > div.game_wrap.w1200.clearfix > div.game_l > div.game_info > div.img_logo > img", ExcelHeader: "A",ConversionFormatFunc: conversion},
